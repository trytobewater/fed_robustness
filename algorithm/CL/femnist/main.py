...
from models.model_utils import femnist_loaders
...
train_data_dir = os.path.join(root_pa, 'yc', 'leaf_new_data', 'femnist', 'data', 'train')

test_data_dir = os.path.join(root_pa, 'yc', 'leaf_new_data', 'femnist', 'data', 'test')
...
trainloader = femnist_loaders('train', train_da)
testloader = femnist_loaders('test', test_da)

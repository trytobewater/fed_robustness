...
def parse_args():
    ...
    parser.add_argument('--num-round', default=101, type=int, metavar='N',
                        help='number of total round to run')
    parser.add_argument('--num-epochs', default=1, type=int, metavar='N',
    ...
    parser.add_argument('--total-clients', default=100, type=int, metavar='N',
                        help='number of selected clients to run in each round')
    ...
    parser.add_argument('-j', '--workers', default=0, type=int, metavar='N',
                    help='number of data loading workers (default: 8)')#default=8

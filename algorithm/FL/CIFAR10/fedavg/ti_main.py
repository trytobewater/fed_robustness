...
def main():
    ...
    data_dir_modify_here_1 = 'train_react_translation_10_3'

    data_dir_modify_here_2 = 'test_react_translation_100_3'

    train_data_dir = os.path.join('./', 'data', 'cifar10', 'data',
                                  data_dir_modify_here_1)
    test_data_dir = os.path.join('./', 'data', 'cifar10', 'data',
                                 data_dir_modify_here_2)
    ...
    if args.start_epoch > 0:
        ...
        load_modify_here = 'normal-'
        checkpoint = torch.load('./checkpoint/light/point' + load_modify_here + str(args.start_epoch) + '.pth')
        checkpoint = checkpoint['net']

        server.set_server_param(checkpoint, clients)
        flag = 0
    ...
    np.save('result-niti-float-avg-translation_10_3_offset.npy', plot_result)

...
from leaf_net import leaf_celeba
...
def main():
    ...
    np.save('result-niti-float-celeba-lenet-no-nor-sgd-1.npy', plot_result)
    ...
    if model_type == 'int':
        ...
        if args.dataset == 'mnist' and args.model == 'lenet':
            ...
            if args.model == 'lenet':
                ...
                print("we choose lenet_celeba net.")
            elif args.model == 'vgg':
                print("we choose celeba_vgg net.")
